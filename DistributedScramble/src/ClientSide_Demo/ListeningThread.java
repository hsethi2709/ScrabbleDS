                    ...
                    if (!inPacket.getContent().getResult()) 
                    {
                        ...
                        while (status) {
                            String s = JOptionPane.showInputDialog(
                                    "Oops! Username is already taken or invalid. Please enter a different username");
                            if (s == null) {
                                closeSocket();
                                status = false;
                                ...
                                JOptionPane.showMessageDialog(new JFrame(),
                                        "Please enter a valid username. A valid username contains only alphabets and numbers. It should be a minimum of length 1.",
                                        "Error", 1);
                            }
                        }
                    }
